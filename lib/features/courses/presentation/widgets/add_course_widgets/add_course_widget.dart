import 'package:e_sheet/features/courses/presentation/widgets/add_course_widgets/add_button_widget.dart';
import 'package:e_sheet/features/courses/presentation/widgets/add_course_widgets/text_field_add_course.dart';
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          AddButton(courseEnteredName: courseEnteredName, formKey: formKey,),
        ],
      ),
    );
  }
